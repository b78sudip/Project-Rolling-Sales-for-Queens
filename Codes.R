...
#For example, setwd("C:/Rprojects/Project-Rolling-Sales-for-Queens")
#You can verify directory with getwd()

qn <- read.csv("data/rollingsales_queens.csv",skip=4,header=TRUE)
head(qn)
dim(qn)
